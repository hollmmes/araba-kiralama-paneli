...
class Ui_anapencere(object):
    def setupUi(self, anapencere):
        ...
        anapencere.resize(483, 409)
        anapencere.setStyleSheet(u"background-color: rgb(50, 50, 50);")
        self.centralwidget = QWidget(anapencere)
        self.centralwidget.setObjectName(u"centralwidget")
        self.gridLayoutWidget = QWidget(self.centralwidget)
        self.gridLayoutWidget.setObjectName(u"gridLayoutWidget")
        self.gridLayoutWidget.setGeometry(QRect(30, 100, 401, 171))
        ...
        self.aracbilgi_plaka = QPushButton(self.gridLayoutWidget)
        self.aracbilgi_plaka.setObjectName(u"aracbilgi_plaka")
        self.aracbilgi_plaka.setFont(font)

        self.gridLayout_2.addWidget(self.aracbilgi_plaka, 4, 1, 1, 1)
    ...
    def retranslateUi(self, anapencere):
        ...
        self.label_4.setText(QCoreApplication.translate("anapencere", u"Ara\u00e7 Kiralama", None))
        ...
        self.label_3.setText(QCoreApplication.translate("anapencere", u"Ara\u00e7 Giri\u015f", None))
        self.label_6.setText(QCoreApplication.translate("anapencere", u"Plaka sorgu", None))
