...
class Ui_Bul(object):
    def setupUi(self, Form):
        ...
        Form.setStyleSheet(u"background-color: rgb(112, 112, 112);")
        ...
        self.pushButton_getir1 = QPushButton(self.formLayoutWidget)
        self.pushButton_getir1.setObjectName(u"pushButton_getir1")

        self.gridLayout_2.addWidget(self.pushButton_getir1, 8, 5, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_getir1.setText(QCoreApplication.translate("Form", u"Getir", None))
